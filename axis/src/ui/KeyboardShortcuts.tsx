...
export function KeyboardShortcuts() {
  ...
  return (
    <div className="absolute inset-0 z-[60] flex items-center justify-center bg-mil-900/70">
      <div className="seam border border-mil-500 bg-mil-800 p-4">
        <div className="mb-2 flex items-center justify-between">
          ...
          <button
            ...
            className="font-mono text-[10px] text-mil-200 hover:text-mil-50"
          >
            ×
          </button>
        </div>
        <table className="font-mono text-[11px] text-mil-100">
          <tbody>
            {[
              ["[", "Toggle left dock"],
              ["]", "Toggle right panel"],
              ...
              <tr key={k}>
                <td className="pr-4 text-mil-200">{k}</td>
                <td>{v}</td>
              </tr>
            ))}
          </tbody>
