...
export function DecisionPipMap({ regionId }: { regionId: string | null }) {
  ...
  return (
    <div
      ref={wrapRef}
      className="seam z-[200001] flex w-56 flex-col overflow-hidden border border-mil-500 bg-mil-900/90 shadow-glow"
      style={{
        position: "fixed",
        ...(pos
    ...
    >
      <button
        ...
        className="shrink-0 cursor-grab border-b border-mil-600 bg-mil-800 px-2 py-1 text-left font-mono text-[8px] uppercase tracking-wider2 text-mil-200 active:cursor-grabbing"
        title="Drag to move"
      >
        · · · move
      </button>
      <div className="relative h-40 w-full">
        ...
        <div
          ref={boxRef}
          className="pointer-events-none absolute border border-mil-50/50"
      ...
      <div className="seam-t bg-mil-900/80 px-2 py-0.5 font-mono text-[8px] uppercase tracking-wider2 text-mil-200">
