...
export function FactorFlowGraph({
  ...
  return (
    <div className="seam flex h-full min-h-0 w-full min-w-0 flex-1 flex-col overflow-hidden border border-mil-500 bg-mil-800/50">
      <div className="flex items-baseline justify-between border-b border-mil-600 px-3 py-2">
        <span className="font-mono text-[10px] uppercase tracking-wider2 text-mil-200">
          factor graph
        </span>
        <div className="max-w-[72%] text-right font-mono text-[8px] uppercase tracking-wider2 leading-snug text-mil-300">
      ...
      >
        <svg
          ...
          className="h-full min-h-[240px] cursor-grab text-mil-100 active:cursor-grabbing"
          role="img"
