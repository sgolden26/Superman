...
export function FilterChips() {
  ...
  return (
    <div className="space-y-3 px-3 py-3">
      {GROUPS.map((group) => (
        <div key={group.label}>
          <div className="mb-1.5 font-mono text-[9px] uppercase tracking-wider2 text-mil-300">
            {group.label}
          </div>
                ...
                <button
                  ...
                  className={`border px-2 py-[3px] font-mono text-[9px] uppercase tracking-wider2 transition-colors ${
                    active
                      ...
                      : "border-[rgba(255,255,255,0.06)] bg-mil-700/40 text-mil-200 hover:border-[rgba(255,255,255,0.14)] hover:text-mil-50"
                  }`}
                  aria-pressed={active}
