        ...
        <div className="px-4 py-3">
          <div className="flex items-baseline justify-between">
            <div className="flex items-baseline gap-1">
              ...
              <span className="font-mono text-[11px] text-mil-200">/100</span>
            </div>
            <span
          ...
          {region.drivers[0] && (
            <div className="mt-2 border-l-2 border-mil-400 pl-3 text-[11px] leading-snug text-mil-100">
              Driven by{" "}
          ...
          <div className="mt-2 font-mono text-[10px] uppercase tracking-wider2 text-mil-200">
            full breakdown in decision engine →
          </div>
        </div>
      ) : (
        <div className="px-4 py-3 font-mono text-[11px] leading-relaxed text-mil-200">
