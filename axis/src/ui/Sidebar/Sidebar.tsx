...
export function Sidebar() {
  ...
  return (
    <div className="flex h-full flex-col deck-surface">
      <div className="seam-b flex items-center justify-between gap-3 px-4 py-2">
        <span className="min-w-0 truncate font-mono text-[10px] uppercase tracking-wider2 text-mil-200">
          contact
          {kindBreadcrumb ? (
            <>
              <span className="px-1.5 text-mil-300">/</span>
              <span className="text-mil-100">{kindBreadcrumb}</span>
            </>
          ) : null}
          {selection ? (
            <>
              <span className="px-1.5 text-mil-300">/</span>
              <span className="text-mil-50">{title}</span>
            </>
          ) : null}
        </span>
        {selection && (
          <button
            ...
            className="shrink-0 font-mono text-[10px] uppercase tracking-wider2 text-mil-200 transition-colors hover:text-mil-50"
