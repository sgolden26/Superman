    ...
    <div className="flex h-full flex-col">
      <div className="seam-b px-4 pb-3 pt-4">
        ...
        <div className="mt-1 flex items-baseline gap-2">
          ...
          {unit.callsign && (
            <span className="font-mono text-[11px] text-mil-300">/{unit.callsign}</span>
          )}
        </div>
      ...
      {!playerOwnsUnit ? (
        <div className="px-4 py-3 font-mono text-[10px] uppercase tracking-wider2 text-mil-200">
          ...
          {draft && (
            <div className="mt-2 flex flex-wrap items-center gap-2">
              <button
                ...
                className="seam border border-accent-ok bg-accent-ok/10 px-2 py-1 font-mono text-[9px] uppercase tracking-wider2 text-accent-ok transition-colors hover:bg-accent-ok/20 disabled:cursor-not-allowed disabled:opacity-40 disabled:hover:bg-accent-ok/10"
              >
              ...
              <button
                ...
                className="seam border border-accent-danger bg-accent-danger/10 px-2 py-1 font-mono text-[9px] uppercase tracking-wider2 text-accent-danger transition-colors hover:bg-accent-danger/20"
              >
                Cancel
              </button>
            </div>
...
function btnClass(active: boolean): string {
  return `border px-2 py-1.5 text-left font-mono text-[10px] uppercase tracking-wider2 transition-colors ${
    active
      ...
      : "border-[var(--seam)] bg-mil-700/30 text-mil-100 hover:border-[var(--seam-strong)] hover:bg-mil-700/60 hover:text-mil-50"
  }`;
}
