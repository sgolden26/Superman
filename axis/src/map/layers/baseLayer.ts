...
export const SOURCE_COUNTRY_BASES = "sm-country-bases";
export const LAYER_COUNTRY_BASE_DOT = "sm-country-base-dot";
export const LAYER_COUNTRY_BASE_LABEL = "sm-country-base-label";
