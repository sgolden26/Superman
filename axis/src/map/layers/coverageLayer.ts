...
export const SOURCE_ISR = "sm-isr";
export const SOURCE_MISSILE = "sm-missile";
export const SOURCE_AOR = "sm-aor";

export const LAYER_ISR_FILL = "sm-isr-fill";
export const LAYER_ISR_LINE = "sm-isr-line";
export const LAYER_MISSILE_FILL = "sm-missile-fill";
export const LAYER_MISSILE_LINE = "sm-missile-line";
export const LAYER_AOR_FILL = "sm-aor-fill";
export const LAYER_AOR_LINE = "sm-aor-line";
