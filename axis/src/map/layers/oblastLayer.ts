...
export const SOURCE_OBLASTS = "sm-oblasts";
export const LAYER_OBLAST_FILL = "sm-oblast-fill";
export const LAYER_OBLAST_LINE = "sm-oblast-line";
export const LAYER_OBLAST_LABEL = "sm-oblast-label";
