...
export const SOURCE_COUNTRIES = "sm-countries";
export const SOURCE_COUNTRY_CONTEXT = "sm-countries-context";
export const LAYER_COUNTRY_FILL = "sm-country-fill";
export const LAYER_COUNTRY_LINE = "sm-country-line";
export const LAYER_COUNTRY_CONTEXT_FILL = "sm-country-context-fill";
export const LAYER_COUNTRY_CONTEXT_LINE = "sm-country-context-line";
