...
export const SOURCE_ASSETS = "sm-assets";
export const LAYER_ASSET_DOT = "sm-asset-dot";
export const LAYER_ASSET_LABEL = "sm-asset-label";
export const LAYER_ASSET_PLATE = "sm-asset-plate";
export const SOURCE_DOCK_BADGE = "sm-dock-badge";
export const LAYER_DOCK_BADGE_PLATE = "sm-dock-badge-plate";
export const LAYER_DOCK_BADGE_TEXT = "sm-dock-badge-text";
