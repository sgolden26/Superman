...
export const SOURCE_FRONTLINE_BUFFER = "sm-frontline-buffer";
export const SOURCE_FRONTLINE_LINE = "sm-frontline-line";
export const LAYER_FRONTLINE_BUFFER = "sm-frontline-buffer";
export const LAYER_FRONTLINE_LINE = "sm-frontline-line";
