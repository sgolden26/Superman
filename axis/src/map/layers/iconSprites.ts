 ...
 *
 * Visual language: monochrome, geometric strokes so markers read cleanly on faction-tinted faceplates.
 */

const ICON_PX = 32;

const ASSET_ICON_PREFIX = "sm-asset-";
const CITY_ICON_ID = "sm-city-icon";
