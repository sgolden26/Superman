...
/** Symbol layer id for NATO-style three-letter unit kind codes over domain icons. */
export const LAYER_UNIT_GLYPH = "sm-unit-glyph";
...
const KIND_GLYPH: Record<Unit["kind"], string> = {
  infantry_brigade: "INF",
  armoured_brigade: "ARM",
  air_wing: "AIR",
  naval_task_group: "NAV",
};
 ...
 * with the map as an icon sprite. Faction-tinted fills and a dark seam-weight
