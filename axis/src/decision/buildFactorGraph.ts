...
/**
 * Builds a lightweight fusion diagram from `RegionIntel`: ingested headlines land
 * as signal nodes, drivers explain factor pressure, morale summarises regional
 * posture, and evaluator actions cap the chain.
 *
 * Deterministic layout only (no server hop); gives players an at-a-glance sense
 * of how narrative inputs relate to the advisory COAs.
 */
