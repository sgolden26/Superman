...
/** Combat ranges (km). Mirror backend constants in `superman.sim.combat`. */
...
/** Semantic tag for the geographic candidate under the cursor.
 *
 * Strike workflows reuse `StrikeTargetKindDTO` labels verbatim; planning modes
 * such as air rebase or naval reposition instead reference allied facilities,
 * not hostile objectives. */
