"""Exercise-grade country JSON used when no external loader exists.

Figures cite open reporting through early 2025 for colour only. Production
loads would sit behind `CountryRepository`; this stub remains the deterministic
offline seed.
"""
