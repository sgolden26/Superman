"""Political artefacts: bilateral credibility tracks, faction pressure blocks,
leader-of-record rhetoric.

Stores Phase 9 value types only. Engines that mutate or derive these numbers
sit in `superman.intel.pressure` plus `superman.intel.credibility` (wired later).
...
class LeaderSignalType(str, Enum):
    """Superman-local taxonomy mapped from CAMEO codes at ingest.
