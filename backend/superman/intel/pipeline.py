"""Pull events from a selected `IntelSource`, aggregate morale, write JSON."""
...
from superman import INTEL_SCHEMA_VERSION
from superman.intel.events import Event
from superman.intel.morale import IntelSnapshot, aggregate_all
from superman.intel.sources import (
    CuratedSource,
    GdeltLiveSource,
    GdeltSnapshotSource,
    IntelSource,
)
from superman.settings import Settings, load_settings, resolve_intel_source
