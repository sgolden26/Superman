"""Rich country dossier tree slotted under factions.

Each country hangs off one `Faction` plus eight nested blocks describing
government, force structure, nuclear signalling, demographics, diplomacy,
energy posture, public sentiment, and geography. Immutable dataclasses keep
the graph hashable; guarded `__post_init__` checks numeric windows.
"""
