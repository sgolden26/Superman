"""Produce `state.json`-shaped payloads from an in-memory `Theater`."""
...
from superman import SCHEMA_VERSION
from superman.decision.actions import DEFAULT_ACTIONS, Action, action_catalog_to_dict
