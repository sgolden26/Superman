...
export const cityPlateLayer: LayerSpecification = {
  ...
  paint: {
    ...
    "circle-radius": [
      ...
      3, ["match", ["get", "importance"], "capital", 7.5, "major", 6, 5],
      6, ["match", ["get", "importance"], "capital", 11, "major", 9, 7.5],
      9, ["match", ["get", "importance"], "capital", 14, "major", 12, 10],
    ],
    "circle-opacity": 0.95,
  },
};
...
export const cityIconLayer: LayerSpecification = {
  ...
  layout: {
    ...
    "icon-size": [
      "interpolate", ["linear"], ["zoom"],
      3, ["match", ["get", "importance"], "capital", 0.46, "major", 0.38, 0.32],
      6, ["match", ["get", "importance"], "capital", 0.66, "major", 0.55, 0.46],
      9, ["match", ["get", "importance"], "capital", 0.85, "major", 0.72, 0.61],
    ],
